...
_APPKIT_PRIVATE_DEF_SEL(addItemWithTitle_action_keyEquivalent_, "addItemWithTitle:action:keyEquivalent:");

_APPKIT_PRIVATE_DEF_SEL(applicationDidFinishLaunching_, "applicationDidFinishLaunching:");

_APPKIT_PRIVATE_DEF_SEL(applicationShouldTerminateAfterLastWindowClosed_, "applicationShouldTerminateAfterLastWindowClosed:");

_APPKIT_PRIVATE_DEF_SEL(applicationWillFinishLaunching_, "applicationWillFinishLaunching:");
_APPKIT_PRIVATE_DEF_SEL(applicationWillTerminate_, "applicationWillTerminate:");
_APPKIT_PRIVATE_DEF_SEL(applicationWillBecomeActive_, "applicationWillBecomeActive:");
_APPKIT_PRIVATE_DEF_SEL(applicationDidBecomeActive_, "applicationDidBecomeActive:");
...
_APPKIT_PRIVATE_DEF_SEL(initWithContentRect_styleMask_backing_defer_, "initWithContentRect:styleMask:backing:defer:");
...
_APPKIT_PRIVATE_DEF_SEL(center_, "center");
