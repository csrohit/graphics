...
class WindowDelegate: public Referencing<WindowDelegate>
{
    public:
        ...
        virtual void windowWillClose(const NS::Notification* pNotification){};
};
...
//
// _NS_INLINE NS::WindowDelegate* NS::WindowDelegate::alloc()
// {
// 	return Object::sendMessage< WindowDelegate* >( _APPKIT_PRIVATE_CLS( NSWindowDelegate ), _NS_PRIVATE_SEL( alloc ) );
// }
...
{
	Object::sendMessage< void >( this, _APPKIT_PRIVATE_SEL( center_ ) );
}
