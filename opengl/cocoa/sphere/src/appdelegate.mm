...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    window = [[NSWindow alloc]
        initWithContentRect:NSMakeRect(0.0, 0.0, WIN_WIDTH, WIN_HEIGHT)
...
- (void) applicationDidBecomeActive:(NSNotification *)notification {
 ...
 -(void) applicationDidunHide:(NSNotification *)notification {
     fprintf(gpFile, "Application Did unhide\n");
 }
 -(void) applicationWillunHide:(NSNotification *)notification {
     fprintf(gpFile, "Application will unhide\n");
 }
 -(void) applicationDidHide:(NSNotification *)notification {
     fprintf(gpFile, "Application did hide\n");
 }
 -(void) applicationWillHide:(NSNotification *)notification {
     fprintf(gpFile, "Application will hide\n");
 }
