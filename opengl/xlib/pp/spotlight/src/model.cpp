    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                do
                {
                    ssize_t val = fread(pModel->pIndices + totalRead, sizeof(uint32_t), pModel->header.nIndices - totalRead, pFile);
                    if (0 >= val)
                    {
                ...
                do
                {
                    ssize_t val = fread(pModel->pVertices + totalRead, sizeof(Vertex), pModel->header.nVertices - totalRead, pFile);
                    if (0 >= val)
                    {
